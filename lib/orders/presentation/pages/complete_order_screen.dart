  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: false,
          titleSpacing: 0,
          title: Text('Complete Orders', style:getRegularStyle(fontSize: 18, color: ColorManager.black700)),
            ...
            child: ListView.builder(
              itemBuilder: (BuildContext buildContext, index) {
                return InkWell(
                  ...
                  child: CompleteOrderItem(items[index]),
                );
              },
...
class CompleteOrderItem extends StatelessWidget{

  const CompleteOrderItem(String item, {super.key});
